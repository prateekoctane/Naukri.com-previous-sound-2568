...
export function NaukriApp() {
    ...
    return <Box display="flex" m="auto" mt="100px" h="350px" w="90%" justifyContent="space-between" bg="blue.100" boxShadow="lg" borderRadius="20px" p="10px" pb="20px" >

        <Box w="30%" h="200px" mt="100px">
